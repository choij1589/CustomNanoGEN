...
config.JobType.psetName = '../configs/Hadronizer_TuneCP5_13TeV_TTToHcToWAToMuMu_MultiLepFilter_LHE_pythia8_cfg.py'
config.JobType.allowUndistributedCMSSW = True
config.JobType.numCores = 1

config.Data.outputPrimaryDataset = 'Test_TTToHcToWAToMuMu_NANOGEN'
