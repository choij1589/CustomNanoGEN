...
process.particleLevel = cms.EDProducer("ParticleLevelProducer",
    ...
    lepMaxEta = cms.double(999.0),
    lepMinPt = cms.double(0.0),
    particleMaxEta = cms.double(999.0),
...
process.RandomNumberGeneratorService = cms.Service("RandomNumberGeneratorService",
    ...
    externalLHEProducer = cms.PSet(
        engineName = cms.untracked.string('MixMaxRng'),
        initialSeed = cms.untracked.uint32(92)
    ),
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS'),
    globaltag = cms.string('130X_mcRun3_2023_realistic_v14'),
...
process.tauTask = cms.Task(process.finalTaus)
...
process.nanogenSequence = cms.Sequence(process.nanoMetadata+process.genJetTable+process.patJetPartonsNano+process.genJetFlavourAssociation+process.genJetFlavourTable+process.genJetAK8Table+process.genJetAK8FlavourAssociation+process.genJetAK8FlavourTable+cms.Sequence(process.genTauTask)+process.genTable+process.genFilterTable+cms.Sequence(process.genParticleTablesTask)+cms.Sequence(process.genVertexTablesTask)+process.tautagger+process.rivetProducerHTXS+cms.Sequence(process.particleLevelTablesTask)+process.metMCTable+process.genWeightsTable, cms.Task(process.particleLevel, process.rivetProducerHTXS, process.tautagger))
...
process.nanoAOD_step = cms.Path(process.generator+process.nanogenSequence)
...
process.schedule = cms.Schedule(*[ process.lhe_step, process.generation_step, process.genfiltersummary_step, process.nanoAOD_step, process.endjob_step, process.NANOAODGENoutput_step ], tasks=[process.patAlgosToolsTask])
