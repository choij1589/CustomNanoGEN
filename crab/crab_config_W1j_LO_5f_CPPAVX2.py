...
config.General.requestName     = 'W1j_LO_5f_CPPAVX2'
config.General.transferOutputs = True
config.General.transferLogs    = False

### JobType configuration
config.JobType.psetName        = '../configs/Hadronizer_TuneCP5_13p6TeV_W1j_LO_5f_CPPAVX2_LHE_pythia8_cfg.py'
...
### Data configuration
config.Data.outputPrimaryDataset = 'W1j_LO_5f_CPPAVX2'
