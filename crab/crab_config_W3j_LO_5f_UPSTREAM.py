...
config.General.requestName     = 'W3j_LO_5f_UPSTREAM'
config.General.transferOutputs = True
config.General.transferLogs    = False

### JobType configuration
config.JobType.psetName        = '../configs/Hadronizer_TuneCP5_13p6TeV_W3j_LO_5f_UPSTREAM_LHE_pythia8_cfg.py'
...
### Data configuration
config.Data.outputPrimaryDataset = 'W3j_LO_5f_UPSTREAM'
