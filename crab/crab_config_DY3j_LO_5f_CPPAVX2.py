...
config.General.requestName     = 'DY3j_LO_5f_CPPAVX2'
config.General.transferOutputs = True
config.General.transferLogs    = False

### JobType configuration
config.JobType.psetName        = '../configs/Hadronizer_TuneCP5_13p6TeV_DY3j_LO_5f_CPPAVX2_LHE_pythia8_cfg.py'
...
### Data configuration
config.Data.outputPrimaryDataset = 'DY3j_LO_5f_CPPAVX2'
