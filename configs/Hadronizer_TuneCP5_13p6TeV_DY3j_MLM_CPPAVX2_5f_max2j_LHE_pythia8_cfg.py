...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/CustomNanoGEN/python/Hadronizer_TuneCP5_13p6TeV_DY3j_MLM_CPPAVX2_5f_max2j_LHE_pythia8_cff.py nevts:50000'),
