...
# with command line options: Configuration/CustomNanoGEN/Hadronizer_TuneCP5_13p6TeV_DY01234j_LO_5f_CUDA_LHE_pythia8_cff.py --python_filename configs/Hadronizer_TuneCP5_13p6TeV_DY01234j_LO_5f_CUDA_LHE_pythia8_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN --fileout file:GEN.root --mc --conditions auto:mc --step LHE,GEN -n 100000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/CustomNanoGEN/Hadronizer_TuneCP5_13p6TeV_DY01234j_LO_5f_CUDA_LHE_pythia8_cff.py nevts:100000'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring(
        'root://eosuser.cern.ch//eos/user/c/choij/public/MG4GPU/gridpacks/DY01234j_LO_5f_CUDA_el8_amd64_gcc12_CMSSW_14_0_9_tarball.tar.xz',
        '5000',
        '4',
        '1',
        '2',
