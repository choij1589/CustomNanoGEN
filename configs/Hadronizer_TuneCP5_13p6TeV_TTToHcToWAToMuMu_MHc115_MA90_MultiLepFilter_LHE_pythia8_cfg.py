...
# with command line options: Configuration/CustomNanoGEN/python/Hadronizer_TuneCP5_13p6TeV_TTToHcToWAToMuMu_MHc115_MA90_MultiLepFilter_LHE_pythia8_cff.py --no_exec -n 30 --fileout file:NANOGEN.root --mc --eventcontent NANOAODGEN --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --customise Configuration/DataProcessing/Utils.addMonitoring --python_filename configs/Hadronizer_TuneCP5_13p6TeV_TTToHcToWAToMuMu_MHc115_MA90_MultiLepFilter_LHE_pythia8_cfg.py
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/CustomNanoGEN/python/Hadronizer_TuneCP5_13p6TeV_TTToHcToWAToMuMu_MHc115_MA90_MultiLepFilter_LHE_pythia8_cff.py nevts:30'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('root://eosuser.cern.ch//eos/user/c/choij/HcToWA/gridpacks/TTToHcToWA_AToMuMu_MHc115_MA90_el8_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
