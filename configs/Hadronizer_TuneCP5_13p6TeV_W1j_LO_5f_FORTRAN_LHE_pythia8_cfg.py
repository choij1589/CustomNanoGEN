...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/CustomNanoGEN/python/Hadronizer_TuneCP5_13p6TeV_W1j_LO_5f_FORTRAN_LHE_pythia8_cff.py nevts:5000'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('root://eosuser.cern.ch//eos/user/c/choij/MG4GPU/gridpacks/W1j_LO_5f_FORTRAN_el9_amd64_gcc12_CMSSW_14_0_9_tarball.tar.xz'),
