...
# with command line options: Configuration/CustomNanoGEN/python/Hadronizer_TuneCP5_13p6TeV_DY012j_MLM_CPPAVX2_5f_max2j_LHE_pythia8_cff.py --python_filename configs/Hadronizer_TuneCP5_13p6TeV_DY012j_MLM_CPPAVX2_5f_max2j_LHE_pythia8_cfg.py --eventcontent NANOAODGEN --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAOD --fileout file:NANOGEN.root --conditions 130X_mcRun3_2023_realistic_v14 --beamspot Realistic25ns13p6TeVEarly2023Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(46) process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(243) --step LHE,GEN,NANOGEN --geometry DB:Extended --era Run3_2023 --no_exec --mc -n 50000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/CustomNanoGEN/python/Hadronizer_TuneCP5_13p6TeV_DY012j_MLM_CPPAVX2_5f_max2j_LHE_pythia8_cff.py nevts:50000'),
