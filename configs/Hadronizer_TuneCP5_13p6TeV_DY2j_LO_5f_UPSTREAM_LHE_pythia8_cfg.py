...
# with command line options: Configuration/CustomNanoGEN/python/Hadronizer_TuneCP5_13p6TeV_DY2j_LO_5f_UPSTREAM_LHE_pythia8_cff.py --python_filename configs/Hadronizer_TuneCP5_13p6TeV_DY2j_LO_5f_UPSTREAM_LHE_pythia8_cfg.py --eventcontent NANOAODGEN --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAOD --fileout file:NANOGEN.root --conditions 130X_mcRun3_2023_realistic_v14 --beamspot Realistic25ns13p6TeVEarly2023Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(17) process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(243) --step LHE,GEN,NANOGEN --geometry DB:Extended --era Run3_2023 --no_exec --mc -n 5000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/CustomNanoGEN/python/Hadronizer_TuneCP5_13p6TeV_DY2j_LO_5f_UPSTREAM_LHE_pythia8_cff.py nevts:5000'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('root://eosuser.cern.ch//eos/user/c/choij/MG4GPU/gridpacks/DY2j_LO_5f_UPSTREAM_el9_amd64_gcc12_CMSSW_14_0_9_tarball.tar.xz'),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(17)
