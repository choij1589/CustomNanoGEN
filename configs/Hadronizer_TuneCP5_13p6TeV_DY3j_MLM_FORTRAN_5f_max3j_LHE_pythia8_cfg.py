...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('root://eosuser.cern.ch//eos/user/c/choij/MG4GPU/gridpacks/DY3j_LO_5f_FORTRAN_el9_amd64_gcc12_CMSSW_14_0_9_tarball.tar.xz'),
